...
public class AccessPoint {
    ...
    public static void LoginLoop() {
        ...
        Customer test = new Customer("John", "Patel", "03/12/16", "NJ", "08857", "4848", "732-914-2834", "idontknow@gmail.com", "admin", "user");
...
class Customer {
    ...
    private Customer() {
     ...
     private Customer(String fN, String lN, String doB, String sOR, String zC, String lFDoSS, String pN, String ema, String user, String pass) {
        this.firstName = fN;
        this.lastName = lN;
    ...
    private void DisplayUserDetails() {
        System.out.printf("Name: %s", firstName + " " + lastName);
    ...
    public static Customer RegisterAccount() {
        ...
        System.out.printf("Full name: %s\n", localCustomer.firstName + " " + lastName);
